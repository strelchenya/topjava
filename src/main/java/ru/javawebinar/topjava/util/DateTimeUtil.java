...
public class DateTimeUtil {
    ...
    public static LocalDate parseLocalDate(String dateString, LocalDate localDate) {
        return StringUtils.isEmpty(dateString) ? localDate : LocalDate.parse(dateString);
    }

    public static LocalTime parseLocalTime(String timeString, LocalTime localTime) {
        return StringUtils.isEmpty(timeString) ? localTime : LocalTime.parse(timeString);
    }

    public static String toString(LocalDateTime ldt) {
        return ldt == null ? "" : ldt.format(dateTimeFormatter);
    }
